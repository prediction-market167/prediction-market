    ...
    >
      <div className="w-full max-w-sm animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-ink-100">Welcome back</h1>
          <p className="text-sm text-ink-600 mt-1">Sign in to your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit((d) => mutate(d))} className="space-y-4">
            ...
            {error && (
              <div className="bg-no/10 border border-no/30 rounded-xl px-4 py-3">
                <p className="text-xs text-no">Invalid email or password</p>
              </div>
            )}
